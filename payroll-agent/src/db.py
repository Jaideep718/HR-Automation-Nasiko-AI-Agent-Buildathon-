"""
Supabase client configuration for Payroll Automation Agent.
Connects to Supabase via HTTPS REST API.
"""
import os
...
def check_db_connection() -> bool:
    ...
    """
    try:
        supabase.table("employees").select("employee_id").limit(1).execute()
        return True
    except Exception:
        return False
